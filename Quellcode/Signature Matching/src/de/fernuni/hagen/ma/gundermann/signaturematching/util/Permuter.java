package de.fernuni.hagen.ma.gundermann.signaturematching.util;

import java.util.Arrays;
import java.util.Collection;

/**
 * Ermoeglicht die Permutation der Argumente einer Methode.
 * 
...
public final class Permuter {
	...
	public static <T> void permuteRecursiveWithOriginalPositionCached(int n, T[] arguments, Integer[] positions,
			Collection<T[]> accumulator, Collection<Integer[]> positionAccumulator) {
		if (n == 1) {
			...
			permuteRecursiveWithOriginalPositionCached(n - 1, arguments, positions, accumulator, positionAccumulator);
		}
	}

	public static <T> void permuteRecursive(int n, T[] arguments, Collection<T[]> accumulator) {
		if (n == 1) {
