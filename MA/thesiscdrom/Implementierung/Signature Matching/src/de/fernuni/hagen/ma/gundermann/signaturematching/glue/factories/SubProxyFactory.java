...
/**
 * {@link ProxyFactory} fuer Sub-Proxies
 * 
 * @author Niels Gundermann
 *
 * @param <T> Source-Type
 */
public class SubProxyFactory<T> implements ProxyFactory<T> {

	private final Class<T> sourceType;

	public SubProxyFactory(Class<T> sourceType) {
	...
	static class SubProxyFactoryCreator implements ProxyFactoryCreator {
