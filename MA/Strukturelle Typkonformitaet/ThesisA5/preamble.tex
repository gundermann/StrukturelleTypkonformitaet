...
\usepackage{fancyhdr}
\usepackage{amssymb}
%\usepackage[some]{background} % Draft Wasserzeichen mit Option pages=all sonst pages=some
%\usepackage{amsmath}
...
\usepackage{geometry}
\geometry{a5paper,left=10mm,right=10mm} 
...
\lstdefinestyle{dsl}{
	 morekeywords={with, for, proxy, provided, required, extends},
  showspaces=false,
  showtabs=false,
  breaklines=true,
   literate=
