...
%Da eine Funktion jedoch im Vergleich zu einer EJB eine kleinere Einheit bildet, wird es als wahrscheinlicher angesehen, dass Funktionen redundant bereitgestellt wurden, als dass es bei EJB der Fall ist.
%\\\\
