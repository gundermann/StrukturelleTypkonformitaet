...
Für einen reqiured Typ können mehrere provided Typen gefunden werden, die eine strukturelle Übereinstimmung aufwiesen. \tabref{amountMatchedInterfaces} zeigt die Anzahl der strukturell gematchten provided Typen zum jeweiligen reqiured Typ. Diese kommen einzeln oder in Kombination für die semantische Evaluation in Frage.
\begin{table}[H]
\centering
\small
\singlespacing
...
\vft{2}{56766}{$p(2247)-56767$}{1}{0}{Ausgangspunkt für TEI4 \\2. Durchlauf}{tmr_start_tei4_2}
\end{multicols}
\begin{multicols}{2}
\vft{1}{$4984$}{0}{0}{0}{Ausgangspunkt für TEI5 \\1. Durchlauf}{tmr_start_tei5_1}\columnbreak
\vft{2}{244479}{$p(2775)-244480$}{1}{0}{Ausgangspunkt für TEI5 \\2. Durchlauf}{tmr_start_tei5_2}
\end{multicols}
\begin{multicols}{2}
\vft{1}{$1051$}{0}{0}{0}{Ausgangspunkt für TEI6 \\1. Durchlauf}{tmr_start_tei6_1}
\columnbreak
\vft{2}{43360}{$p(1323)-43361$}{1}{0}{Ausgangspunkt für TEI6 \\2. Durchlauf}{tmr_start_tei6_2}
\end{multicols}
\begin{multicols}{2}
\vft{1}{$161294$}{0}{0}{0}{Ausgangspunkt für TEI7 \\1. Durchlauf}{tmr_start_tei7_1}
\columnbreak
\vft{2}{7764501}{$p(52150)-7764502$}{1}{0}{Ausgangspunkt für TEI7 \\2. Durchlauf}{tmr_start_tei7_2}
\end{multicols}
\noindent
