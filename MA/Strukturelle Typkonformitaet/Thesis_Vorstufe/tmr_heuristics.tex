...
\end{enumerate}
\paragraph{Qualitatives Type-Matcher Rating}
...
\paragraph{Quantitatives Type-Matcher Rating}
...
Daher sollten bei der Selektion der Kombinationen von Methoden-Konvertierungsvarianten in Schritt 3 der 2. Stufe des Explorationsalgorithmus (siehe \ref{sem_eval_step3}) zuerst diejenigen Kombinationen gewählt werden, deren Elemente (Methoden-Konvertierungsvarianten) aus ein und derselben Typ-Konvertierungsvariante stammen, sprich deren quantitatives Type-Matcher Rating möglichst hoch ist.
