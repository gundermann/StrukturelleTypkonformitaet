...
\subsubsection{Heuristik - TMR\_Quant: Beachtung des quantitativen Type-Matcher Ratings}\label{tmr_quant}
...
Der Explorationsalgorithmus würde die passende benötigte Komponente im ersten Durchlauf finden. Allerdings würde auch die Typ-Konvertierungsvariante für IOfferedA im schlimmsten Fall innerhalb des ersten Durchlaufs analysiert werden. Die Kombinationen von Typ-Konvertierungsvarianten der beiden angebotenen Interfaces, die im ersten Durchlauf des Explorationsalgorithmus erzeugt werden, sind \abbref{tmr_quant_tkvkombi} zu entnehmen. Darauf aufbauend, würde aus diesen Kombinationen von Typ-Konvertierungsvarianten die Kombinationen von Methoden-Konvertiertungsvarianten erzeugt werden, welche \abbref{tmr_quant_mkvkombi} zu entnehmen sind.
...
\subsubsection{Heuristik - TMR\_Qual: Beachtung des qualitativen Type-Matcher Ratings}\label{tmr_qual}
\myparagraph{Szenario}
